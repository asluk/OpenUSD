...
Run record: [20260921-first](report.json). Source input:
[bundled functional requirements](requirements.md), revision `eab823f46dad7c959019e5ce1851c8295c2a3701`.
Implementation revision: `2b4b9babf655f6004cb1b9646e3fb725a348579b`.
The [runtime derivation](RUNTIME.md), [fixture matrix](FIXTURES.md) and
[build stops](STOPS.md) explain the scope of every result.
...
Each [stop](STOPS.md) records the affected requirements, what is missing,
...
[Generated PR text](PR_BODY.md) · [Run procedure](../../BUILD_LOOP.md).
